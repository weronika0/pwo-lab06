...
/**
 * Typ wyliczeniowy obejmujący wszystkie zrealizowane ciągi. Jest to również
 * menadżer służący do pozyskania obiektu klasy ciągu metodą {@link #getGenerator()
 * }
 *
 * @author tomek
 * @version 1.0.0
...
public enum SeqType {
    ...
    /**
     * Tworzy obiekt generatora. 3 * Korespondujacy z nadaną wartością. 4 * 5 *
